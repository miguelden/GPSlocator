 ...
 * Geodetic to ECEF
 */
TEST(Distance, test_geodetic_to_ecef_001)
{
    float llh0[3] = {34.00000048f, -117.3335693f, 251.702f};
    float xyz0[3];

    geodetic_to_ecef(llh0[0], llh0[1], llh0[2], &xyz0[0], &xyz0[1], &xyz0[2]);
 ...
 * ECEF to ENU
 */
TEST(Distance, test_ecef_to_enu_001)
{
    float llh0[3] = {34.00000048f, -117.3335693f, 251.702f};
    float xyz0[3];
    geodetic_to_ecef(llh0[0], llh0[1], llh0[2], &xyz0[0], &xyz0[1], &xyz0[2]);
    ...
    float enu[3];
    ecef_to_enu(xyz[0], xyz[1], xyz[2], llh0[0], llh0[1], llh0[2], &enu[0], &enu[1], &enu[2]);
 ...
 * ECEF to ENU
 */
TEST(Distance, test_ecef_to_enu_002)
{
    float llh0[3] = {34.00000048f, -117.3335693f, 251.702f};
    float xyz0[3];
    geodetic_to_ecef(llh0[0], llh0[1], llh0[2], &xyz0[0], &xyz0[1], &xyz0[2]);
 ...
 * ECEF to ENU
 */
TEST(Distance, test_ecef_to_enu_003)
{
    float llh0[3] = {34.00000048f, -117.3335693f, 251.702f};
    float xyz0[3];
    geodetic_to_ecef(llh0[0], llh0[1], llh0[2], &xyz0[0], &xyz0[1], &xyz0[2]);
 ...
 * ECEF to ENU
 */
TEST(Distance, test_ecef_to_enu_004)
{
    float llh0[3] = {34.00000048f, -117.3335693f, 251.702f};
    float xyz0[3];
    geodetic_to_ecef(llh0[0], llh0[1], llh0[2], &xyz0[0], &xyz0[1], &xyz0[2]);
 ...
 * Distance
 */
TEST(Distance, test_xyz_distance_001)
{
    float xyz0[3] = {0.0f, 0.0f, 0.0f};
    float xyz1[3] = {0.0f, 0.0f, 0.0f};
    auto dist = xyz_distance(xyz0[0], xyz0[1], xyz0[2], xyz1[0], xyz1[1], xyz1[2]);
 ...
 * Distance
 */
TEST(Distance, test_xyz_distance_002)
{
 ...
 * Distance
 */
TEST(Distance, test_xyz_distance_003)
{
 ...
 * Distance
 */
TEST(Distance, test_xyz_distance_004)
{
 ...
 * Distance
 */
TEST(Distance, test_xyz_distance_005)
{
 ...
 * Distance
 */
TEST(Distance, test_xyz_distance_006)
{
    float xyz0[3] = {-123.4f, -567.8f, -9.0f};
    float xyz1[3] = {-234.8f, -987.2f, -5.2f};
    float exp_dist = 433.959399023f;
...
/**
 * Geodetic to ENU and distance
 */
TEST(Distance, test_geodetic_to_enu_001)
{
    ...
    float enu[3];
    geodetic_to_enu(llh1[0],llh1[1],llh1[2],llh0[0],llh0[1],llh0[2],&enu[0], &enu[1], &enu[2]);

    float dist = xyz_distance(0.0f, 0.0f, 0.0f, enu[0], enu[1], enu[2]);
 ...
 * Geodetic to ENU and distance
 */
TEST(Distance, test_geodetic_to_enu_002)
{
